...
* **Electro-optic modulators:** Use of Lithium Niobate (LiNbO3) electro-optic modulators and phase shifters that modify refractive index ($\Delta n$) via the Pockels effect.
...
* **STAGE 2 (Dynamic reconfigurable matrix):** Dynamic weights are formed by local refractive-index modulation $n(x,y,z)$ using solid-state switches based on PCMs and Lithium Niobate (LiNbO3).
