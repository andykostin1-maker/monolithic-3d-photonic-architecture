...
We released OptoCore-3D, an open behavioral and thermal simulation of a 3D photonic accelerator architecture for Transformer inference.
...
1/ We released OptoCore-3D: an open behavioral simulation of a proposed 3D photonic accelerator for Transformer inference.
...
We published OptoCore-3D, an open behavioral and thermal simulation of a proposed 3D photonic accelerator architecture for Transformer inference.
...
OptoCore-3D is an open behavioral and thermal simulation of a proposed 3D photonic accelerator for Transformer inference.
...
Subject: Request for independent review of an open photonic accelerator simulation

Hello,

I published OptoCore-3D, an open behavioral and thermal simulation of a proposed 3D photonic accelerator for Transformer inference.
